const REPO_NAME = "CODE-201-labs-11";
...
main.style.background = `#181a25 url('/${REPO_NAME}/assets/imgs/Background_image@2x.png') no-repeat center top`;
...
const cardData = [
  {
    ...
    text: "Provide a comprehensive understanding of the customer experience.", // CORRECCIÓN: Usar la ruta absoluta con el nombre del repo
    imgSrc: `/${REPO_NAME}/assets/imgs/photo_1.png`,
  },
  {
    icon: "🗓️",
    title: "Ask Targeted and Specific Questions",
    text: "Avoid vague or open-ended questions that might not yield actionable insights.", // CORRECCIÓN
    imgSrc: `/${REPO_NAME}/assets/imgs/photo_2.png`,
  },
  {
    icon: "📝",
    title: "Prioritize and Respond to Feedback",
    text: "Communicate the changes or improvements you've made in response to their feedback.", // CORRECCIÓN
    imgSrc: `/${REPO_NAME}/assets/imgs/photo_3.png`,
  },
];
